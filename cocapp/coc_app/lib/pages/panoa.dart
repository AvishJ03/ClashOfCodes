...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePanoa(title: 'Flutter Panorama'),
    );
  }
}

class MyHomePanoa extends StatefulWidget {
  MyHomePanoa({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  _MyHomePanoaState createState() => _MyHomePanoaState();
}

class _MyHomePanoaState extends State<MyHomePanoa> {
  double _lon = 0;
  double _lat = 0;
  double _tilt = 0;
  int _panoId = 0;
