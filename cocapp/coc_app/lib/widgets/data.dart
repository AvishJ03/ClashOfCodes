...
List<PlanetInfo> planets = [
  PlanetInfo(1,
      ...
      iconImage: 'lib/images/__familycare.png',
      description:
  ...
  PlanetInfo(2,
      ...
      iconImage: 'lib/images/__employee.png',
      description:
  ...
  PlanetInfo(3,
      ...
      iconImage: 'lib/images/__pension.png',
      description:
  ...
  PlanetInfo(4,
      ...
      iconImage: 'lib/images/__scheme.png',
      description:
  ...
  PlanetInfo(5,
      ...
      iconImage: 'lib/images/__home.png',
      description:
  ...
  PlanetInfo(6,
      ...
      iconImage: 'lib/images/__friends.png',
      description:
