...
const TripForm2 = () => {
    return (
        <div>
            <div className='text-6xl font-bold text-center py-8'>Choose your Interests!</div>
...
<img src={photographer} alt="" className='flex -translate-y-10 '/>
                    ...
                    <div className="category">Do you enjoy capturing moments and memories through photography? Are you someone who loves to snap pictures wherever you go? </div>
                </div>
                ...
                <div className="card  bg-[#C8EFF4]">
                    ...
                    <div className="category">Do you enjoy trying new cuisines, discovering local delicacies, and indulging in delicious food wherever you go? Are you a foodie who loves to explore a destination's culinary scene?</div>
                </div>
                <div className="card  bg-[#C8EFF4]">
                    <div className="card-image">
                    ...
                    <div className="category">Do you sometimes prefer to unwind and relax in the comfort of your own city, exploring new neighborhoods and taking a break from the routine of daily life? Are you someone who enjoys a staycation to recharge and refresh?</div>
                </div>
                <div className="card bg-[#C8EFF4]">
                    <div className="card-image">
                    ...
                    <div className="category">Do you prefer to travel light and immerse yourself in the local culture, staying in budget accommodations and taking public transportation? Are you someone who loves the sense of adventure that comes with backpacking?</div>
                </div>
                <div className="card bg-[#C8EFF4]">
                    <div className="card-image">
                    ...
                    <div className="category">Do you document your travel experiences through writing, photography, or videography? Are you a travel blogger who shares your adventures with the world?</div>
                </div>
                <div className="card">
                    <div className="card-image">
                    ...
                    <div className="category">Are you someone who seeks out new experiences, takes risks, and embraces the thrill of the unknown? Do you consider yourself adventurous?</div>
                </div>
